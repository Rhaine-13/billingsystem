...
document.addEventListener('DOMContentLoaded', function () {
    ...
    okButton.addEventListener('click', function () {
        ...
        // Allow typing after '09'
        contact.addEventListener('input', function (e) {
            // Remove any non-digit characters
            this.value = this.value.replace(/\D/g, '');

            // If the value starts with '09', keep it fixed
            if (this.value.length > 11) {
    this.value = this.value.slice(0, 11);
    showModal("Contact number must be 11 digits."); // Show custom alert
}

            // If the value is less than 2, reset to '09'
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    occupationSelect.addEventListener('change', function (e) {
        // Clear the existing input if "Others" is not selected
        ...
        // If "Others" is selected, create an input field
        if (occupationSelect.value === "Others") {
        ...
        occupationDiv.appendChild(inputOccupation);
            ...
            // If a valid occupation is selected, just display it
